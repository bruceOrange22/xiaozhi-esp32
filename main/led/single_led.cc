...
void SingleLed::OnStateChanged() {
    ...
    switch (device_state) {
        ...
        case kDeviceStateWifiConfiguring:
            ...
            ESP_LOGI(TAG, "Device is configuring WiFi, LED set to red with default brightness.");
            break;
        ...
        case kDeviceStateConnecting:
            SetColor(255, 0, 0);
            TurnOn();
            ESP_LOGI(TAG, "Device is connecting, LED set to red.");
            break;
        case kDeviceStateListening:
            ...
            SetColor(255, 255, 0);
            TurnOn();
            ESP_LOGI(TAG, "Device is connecting, LED set to yellow.");
            break;
        case kDeviceStateSpeaking:
            SetColor(0, 0, 255);
            TurnOn();
            ESP_LOGI(TAG, "Device is speaking, LED set to blue with default brightness.");
            break;
