...
#endif
// 1.28寸圆屏
#define TAG "TestBoard_screen128"
...
class TestBoard_v128 : public WifiBoard
{
private:
    Button boot_button_;
    // 新增 touch_button_ 成员变量
...
public:
    TestBoard_v128() : boot_button_(BOOT_BUTTON_GPIO),
